...
public class TechnicalConsultantGraphicUserInterface {

	public TechnicalConsultantGraphicUserInterface()  { }
	...
	public static void displayTechnicalConsultantGraphicUserInterface(String userDisplayName, String errorMesage, Integer idFacturaDetaliata, ArrayList<String> dataBaseStructure, String currentTableName, String primaryKeyValueForEditableRecord, PrintWriter printWriter) {
		...
		content += "</head>\n";       
		content += "<body>\n";
		content += "<form name=\"formular\" action=\"TechnicalConsultantServlet\" method=\"POST\">\n";  
		...
		content += "<center>\n";
		content += "<h2>Probleme clienti</h2>\n";              
		...
		try {
			...
			for (ArrayList<Object> tableRow:tableContent) {
				...
				if (currentTableName.equals("mesaje")) {
					content += "<td><input type=\"submit\" name=\""+Constants.UPDATE_BUTTON_NAME.toLowerCase()+(isEditableRecord?"2":"1")+"_"+currentPrimaryKey+"\" value=\""+Constants.UPDATE_BUTTON_NAME+"\"></td>\n"
					            		+ "<td><input type=\"submit\" name=\""+Constants.REPLY_BUTTON_NAME.toLowerCase()+"_"+currentPrimaryKey+"\" value=\""+Constants.REPLY_BUTTON_NAME+"\"></td>\n";
				}
