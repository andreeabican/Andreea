...
public class HRMainPage implements EventHandler, Initializable {
	...
	public HRMainPage(int idUserLogat) {
	...
	public void start() throws IOException, SQLException {
		...
		applicationScene = new Scene((Parent)FXMLLoader.load(getClass().getResource("HRMainPage.fxml")));
	...
	@FXML
	public void onInformatiiHRBubbleAction() throws IOException {
		HRManagementGUI hrmanagementgui = new HRManagementGUI(idUserLogat);
		hrmanagementgui.start();
	}
